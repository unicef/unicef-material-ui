...
export default function Pickers() {
  ...
  const iconOptions = [
    ...
    },
    {
      ...
      label: 'Sample 2',
      image:
        '<svg width="56" height="56" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M55 28c0 14.912-12.088 27-27 27S1 42.912 1 28 13.088 1 28 1s27 12.088 27 27z" stroke="#00ADEE" stroke-dasharray="0.994,0.994"/><path d="M42.452 36.714c-7.143-4.519-13.323-.377-13.323.331v-15.06c0-2.678 3.54-4.12 7.906-4.12 2.1 0 4.002.499 5.417 1.314v17.535zm-15.476.331c0-.708-6.186-4.85-13.327-.33V19.178c1.415-.815 3.318-1.315 5.417-1.315 4.37 0 7.91 1.443 7.91 4.12v15.061zm1.181-18.395c-1.105-1.065-7.462-4.764-16.157-.994V38.33h13.174c.453.392 1.528.669 2.786.669 1.255 0 2.333-.277 2.788-.669H44V17.656c-8.338-3.698-15 .214-15.843.994z" fill="#00ADEE"/></g></svg>',
      avatar: (
        <Avatar
          src={svgToBlob(
            '<svg width="56" height="56" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M55 28c0 14.912-12.088 27-27 27S1 42.912 1 28 13.088 1 28 1s27 12.088 27 27z" stroke="#00ADEE" stroke-dasharray="0.994,0.994"/><path d="M42.452 36.714c-7.143-4.519-13.323-.377-13.323.331v-15.06c0-2.678 3.54-4.12 7.906-4.12 2.1 0 4.002.499 5.417 1.314v17.535zm-15.476.331c0-.708-6.186-4.85-13.327-.33V19.178c1.415-.815 3.318-1.315 5.417-1.315 4.37 0 7.91 1.443 7.91 4.12v15.061zm1.181-18.395c-1.105-1.065-7.462-4.764-16.157-.994V38.33h13.174c.453.392 1.528.669 2.786.669 1.255 0 2.333-.277 2.788-.669H44V17.656c-8.338-3.698-15 .214-15.843.994z" fill="#00ADEE"/></g></svg>'
