...
var components = {
  ...
  var label = props.label,
      ...
      others = objectWithoutProperties(props, ['label', 'variant', 'TextFieldProps']);
  ...
  var mergedTextFieldProps = _extends$1({}, defaultTextFieldProps, TextFieldProps);

  return React.createElement(
    'div',
    { className: classes.margin },
    React.createElement(Select$2, _extends$1({
      classes: classes,
      styles: selectStyles,
