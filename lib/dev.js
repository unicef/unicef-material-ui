...
var Select$2 = _interopDefault(require('react-select'));
...
var elementAcceptingRef = chainPropTypes(undefined, acceptingRef);
elementAcceptingRef.isRequired = chainPropTypes(undefined, acceptingRef);
...
function mergeClasses() {
  ...
  if ( typeof newClasses === 'string') {
     warning_1(false, ["Material-UI: the value `".concat(newClasses, "` ") + "provided to the classes prop of ".concat(getDisplayName(Component), " is incorrect."), 'You might want to use the className prop instead.'].join('\n')) ;
    return baseClasses;
  }

  Object.keys(newClasses).forEach(function (key) {
     warning_1(baseClasses[key] || !newClasses[key], ["Material-UI: the key `".concat(key, "` ") + "provided to the classes prop is not implemented in ".concat(getDisplayName(Component), "."), "You can only override one of the following: ".concat(Object.keys(baseClasses).join(','), ".")].join('\n')) ;
     warning_1(!newClasses[key] || typeof newClasses[key] === 'string', ["Material-UI: the key `".concat(key, "` ") + "provided to the classes prop is not valid for ".concat(getDisplayName(Component), "."), "You need to provide a non empty string instead of: ".concat(newClasses[key], ".")].join('\n')) ;
...
function getStylesCreator(stylesOrCreator) {
  var themingEnabled = typeof stylesOrCreator === 'function';
   warning_1(_typeof(stylesOrCreator) === 'object' || themingEnabled, ['Material-UI: the `styles` argument provided is invalid.', 'You need to provide a function generating the styles or a styles object.'].join('\n')) ;
  return {
...
var jss$1 = create(_extends$1({}, jssPreset(), {
	// Define a custom insertion point that JSS will look for when injecting the styles into the DOM.
	insertionPoint: 'jss-insertion-point'
}));

function UNICEFStyleProvider(props) {
...
function findReactChildren(props, componentName) {
...
var Fade = React.forwardRef(function Fade(props, ref) {
  ...
  return React.createElement(reactTransitionGroup.Transition, _extends({
    appear: true,
    in: inProp,
    onEnter: handleEnter,
    onExit: handleExit,
...
var useEnhancedEffect$1 = typeof window !== 'undefined' && "development" !== 'test' ? React.useLayoutEffect : React.useEffect;
/**
...
var TouchRipple = React.forwardRef(function TouchRipple(props, ref) {
  ...
  return React.createElement("span", _extends({
    ...
    ref: container
  }, other), React.createElement(reactTransitionGroup.TransitionGroup, {
    component: null,
    exit: true
  }, ripples));
...
function style$1(options) {
  ...
  var fn = function fn(props) {
    ...
    var styleFromPropValue = function styleFromPropValue(propValueFinal) {
      ...
      return defineProperty$2({}, cssProperty, value);
    };

    return handleBreakpoints(props, propValue, styleFromPropValue);
  };

  fn.propTypes =  defineProperty$2({}, prop, responsivePropType) ;
  fn.filterProps = [prop];
  return fn;
}
...
var getCssProperties = memoize$1(function (prop) {
  ...
  var _prop$split = prop.split(''),
      _prop$split2 = slicedToArray$1(_prop$split, 2),
      a = _prop$split2[0],
      b = _prop$split2[1];
...
var require$$2 = withStyles$1(styles$7, {
  name: 'MuiSvgIcon'
})(SvgIcon);
...
var CancelIcon = createSvgIcon(React.createElement("path", {
...
var Chip$1 = withStyles$1(styles$a, {
  name: 'MuiChip'
})(Chip);
...
var Divider$1 = withStyles$1(styles$e, {
  name: 'MuiDivider'
})(Divider);
...
var Drawer = React.forwardRef(function Drawer(props, ref) {
  ...
  var drawer = React.createElement(Paper$1, _extends({
...
Input.muiName = 'Input';
var Input$1 = withStyles$1(styles$n, {
  name: 'MuiInput'
})(Input);
...
var InputLabel$1 = withStyles$1(styles$o, {
  name: 'MuiInputLabel'
})(InputLabel);
...
var Link = React.forwardRef(function Link(props, ref) {
  ...
  return React.createElement(Typography$1, _extends({
...
var Link$1 = withStyles$1(styles$p, {
  name: 'MuiLink'
})(Link);
...
var List$1 = withStyles$1(styles$q, {
  name: 'MuiList'
})(List);
...
var ListItem$1 = withStyles$1(styles$r, {
  name: 'MuiListItem'
})(ListItem);
...
var Popover$1 = withStyles$1(styles$s, {
  name: 'MuiPopover'
})(Popover);
...
var Menu = React.forwardRef(function Menu(props, ref) {
  ...
  var items = React.Children.map(children, function (child, index) {
    if (!React.isValidElement(child)) {
     ...
     warning_1(child.type !== React.Fragment, ["Material-UI: the Menu component doesn't accept a Fragment as a child.", 'Consider providing an array instead.'].join('\n')) ;
...
var Menu$1 = withStyles$1(styles$t, {
  name: 'MuiMenu',
  withTheme: true
})(Menu);
...
var MenuItem = React.forwardRef(function MenuItem(props, ref) {
  ...
  return React.createElement(ListItem$1, _extends({
    button: true,
    role: role,
    tabIndex: tabIndex,
    component: component,
...
var MenuItem$1 = withStyles$1(styles$u, {
  name: 'MuiMenuItem'
})(MenuItem);
...
var defaultInput$1 = React.createElement(Input$1, null);
...
var Toolbar$1 = withStyles$1(styles$z, {
  name: 'MuiToolbar'
})(Toolbar);
...
var KeyboardArrowLeft = createSvgIcon(React.createElement("path", {
...
var KeyboardArrowRight = createSvgIcon(React.createElement("path", {
...
var TabIndicator$1 = withStyles$1(styles$B, {
...
var TabScrollButton$1 = withStyles$1(styles$C, {
...
var Tabs = React.forwardRef(function Tabs(props, ref) {
  ...
  var indicator = React.createElement(TabIndicator$1, _extends({
...
var Tabs$1 = withStyles$1(styles$D, {
  name: 'MuiTabs',
  withTheme: true
})(Tabs);
...
var TextField$1 = withStyles$1(styles$E, {
  name: 'MuiTextField'
})(TextField);
...
var MenuIcon = unwrapExports(Menu$2);
...
function UHeader(props) {
  var classes = useStyles(props);
  var theme = useTheme$1();

  var _React$useState = React.useState(false),
      _React$useState2 = slicedToArray(_React$useState, 2),
      sideLeft = _React$useState2[0],
      setSideLeft = _React$useState2[1];
  ...
  var position = props.position,
      ...
      logo = props.logo,
      hideLogoBorderLine = props.hideLogoBorderLine,
  ...
  var sideList = React.createElement(
    "div",
    { className: classes.list, role: "presentation" },
    applicationName && React.createElement(
      Typography$1,
      { variant: "h6" },
      "UNICEF ",
      applicationName
  ...
  return React.createElement(
    ...
    React.createElement(
      Toolbar$1,
      { disableGutters: true, className: classes.bgColor },
      React.createElement(
        Box,
        { display: "flex", ml: 3, alignItems: "center" },
        showHamburgerMenu !== false && React.createElement(
          Box,
          { mr: 2 },
          React.createElement(
            IconButton$1,
          ...
          React.createElement(
            Drawer$1,
            { open: sideLeft, onClose: toggleDrawer(false) },
            sideList
          )
        ),
        !hideLogo ? React.createElement(
          Link$1,
          { href: logoUrl },
          React.createElement(
            "svg",
            {
              className: "" + (hideLogoBorderLine !== false && classes.navbarLine),
              width: "114",
              height: "28",
        ...
        React.createElement(
          ...
          React.createElement(
            Link$1,
            { color: "inherit", underline: "none", href: logoUrl && logoUrl },
            applicationName
          )
        )
      ),
      React.createElement(
        Box,
        {
          ...
          ml: "auto",
          bgcolor: colorManipulator_9(theme.palette.primary.main, 0.6),
...
function UHeaderRightButtons(props) {
  return props.children;
}

function UHeaderLeftMenu(props) {
  return props.children;
}
...
var useStyles$2 = makeStyles$1(function (theme) {
  return {
    ...
    drawerPaper: function drawerPaper(props) {
      return {
        zIndex: 999,
        width: props.width || drawerWidth
      };
...
function USideBar(props) {
  ...
  var headerHeight = props.headerHeight,
      width = props.width,
      others = objectWithoutProperties(props, ["headerHeight", "width"]);
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("div", { style: { minHeight: headerHeight } }),
      props.children
    )
  );
}
...
function UHeaderMainMenu(props) {
  var bgcolor = props.bgcolor,
      others = objectWithoutProperties(props, ["bgcolor"]);
...
function UButton(props) {
  var spinButton = props.spinButton,
      loading = props.loading,
      variant = props.variant,
      color = props.color,
      others = objectWithoutProperties(props, ["spinButton", "loading", "variant", "color"]);
  ...
  return spinButton ? React.createElement(
    "div",
    { className: classes.root },
    React.createElement(
      "div",
      ...
      loading && React.createElement(CircularProgress$1, { size: 24, className: classes.buttonProgress })
    )
  ) : React.createElement(
    Button$1,
    _extends$1({
...
function inputComponent(_ref) {
  ...
  return React.createElement('div', _extends$1({ ref: inputRef }, props));
}
...
function Control(props) {
  ...
  return React.createElement(TextField$1, _extends$1({
    fullWidth: true,
    variant: 'outlined',
    InputProps: {
      inputComponent: inputComponent,
...
function Placeholder(props) {
  var selectProps = props.selectProps,
      ...
      innerProps = _props$innerProps === undefined ? {} : _props$innerProps,
      children = props.children;

  return React.createElement(
    Typography$1,
    _extends$1({ color: 'textSecondary' }, innerProps),
    children
  );
}
...
function SingleValue(props) {
  return React.createElement(
    Typography$1,
    _extends$1({ className: props.selectProps.classes.singleValue }, props.innerProps),
    props.children
  );
}
...
function MultiValue(props) {
  return React.createElement(Chip$1, {
    ...
    className: clsx(props.selectProps.classes.chip, defineProperty$1({}, props.selectProps.classes.chipFocused, props.isFocused)),
    onDelete: props.removeProps.onClick,
    deleteIcon: React.createElement(CancelIcon$1, props.removeProps)
  });
}
...
function Menu$3(props) {
  return React.createElement(
    Paper$1,
    _extends$1({ square: true, className: props.selectProps.classes.paper }, props.innerProps),
    props.children
  );
}
...
function CustomSelect() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Typography$1,
        { variant: 'h5', className: classes.margin },
        'Select with search'
      ),
...
exports.UHeader = UHeader;
exports.UHeaderLeftMenu = UHeaderLeftMenu;
exports.UHeaderMainMenu = UHeaderMainMenu;
exports.UHeaderRightButtons = UHeaderRightButtons;
exports.ULayout = ULayout;
exports.UNICEFStyleProvider = UNICEFStyleProvider;
exports.USideBar = USideBar;
exports.theme = theme;
