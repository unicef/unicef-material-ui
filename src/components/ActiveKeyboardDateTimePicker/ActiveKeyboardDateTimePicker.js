...
const useStyles = makeStyles(theme => ({
  ...
  inputPaddingWithLabel: props => ({
    padding: props.inputPadding ? props.inputPadding : '18.5px 14px',
    height: 'auto',
  }),
  input: props => ({
...
/**
 * ActiveKeyboardDateTimePicker is a customized [Material Ui KeyboardDateTimePicker]('https://material-ui-pickers.dev/api/KeyboardDateTimePicker') for more details
 */
export default function ActiveKeyboardDateTimePicker(props) {
...
ActiveKeyboardDateTimePicker.propTypes = {
