        ...
        <Toolbar disableGutters={true} className={classes.bgColor}>
          <Box flexGrow={1} >
            <Box display="flex" flexDirection='row' alignItems="center" justifyContent="start">
              {showHamburgerMenu !== false && <React.Fragment>
                <IconButton
                  edge="start"
