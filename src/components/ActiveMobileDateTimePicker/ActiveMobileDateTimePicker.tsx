...
export interface ActiveMobileDateTimePickerProps
  extends Omit<MobileDateTimePickerProps<Date>, 'value' | 'onChange' | 'sx' | 'renderInput'>,
...
export default function ActiveMobileDateTimePicker({
  ...
  sx,
  ...others
}: ActiveMobileDateTimePickerProps) {
