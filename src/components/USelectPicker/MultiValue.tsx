...
export interface CustomMultiValueProps extends Omit<MultiValueProps<SelectOption, boolean>, 'isFocused'> {
  data: SelectOption
  isFocused?: boolean
  onClick?: () => void
  selectProps?: {
    ...
    <StyledChip
      avatar={
        hideAvatar ? undefined : data.avatar ? (
          (data.avatar as React.ReactElement)
        ) : (
      ...
      {...(readOnly
        ? {}
        : {
            deleteIcon: props.components?.Remove ? <props.components.Remove {...removeProps} /> : undefined,
